...
public class Shape: Equatable {
    ...
    public convenience init(view: UIView) {
        ...
        self.init(frame: view.frame, backgroundColor: view.backgroundColor ?? UIColor.clear, borderColor: UIColor(cgColor: view.layer.borderColor ?? UIColor.clear.cgColor), borderWidth: view.layer.borderWidth, xCenterRelative: xCenterRelative, yCenterRelative: yCenterRelative)
    }
    
    public init(frame: CGRect, backgroundColor: UIColor, borderColor: UIColor = UIColor.clear, borderWidth: CGFloat = 0, xCenterRelative: CGFloat = 1.0, yCenterRelative: CGFloat = 1.0) {
        self.frame = frame
...
public func ==(lhs: Shape, rhs: Shape) -> Bool {
    return lhs.frame == rhs.frame && lhs.backgroundColor == rhs.backgroundColor && lhs.borderWidth == rhs.borderWidth && lhs.borderColor == rhs.borderColor && lhs.xCenterRelative == rhs.xCenterRelative && lhs.yCenterRelative == rhs.yCenterRelative
}
