...
//        print("Superview center coordinate X: \(view.superview?.center.x), Superview center coordinate Y: \(view.superview?.center.y)")
    ...
    public var description: String {
        return "Shape(xCenterRelative: CGFloat(\(xCenterRelative)), yCenterRelative: CGFloat(\(yCenterRelative)), widthRelative: CGFloat(\(widthRelative)), heightRelative: CGFloat(\(heightRelative)))"
    }
